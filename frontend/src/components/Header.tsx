...
const Header = () => {
    ...
    return (
        <header className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 shadow-lg sticky top-0 z-50 py-6">
            <Link to="/">
                        ...
                        <div className="flex items-center space-x-4">
                            {user ? (
                                ...
                                <div className="flex items-center gap-3">
                                    <Link to="/user-profile" className="flex items-center gap-2 text-white">
